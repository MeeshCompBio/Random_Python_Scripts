...
Virtual environments create an isolated python environment that is easy to setup/destroy and allows for precise pacakge control depending on your project. Here is a brief tutorial on using miniconda to set up environments.
```bash
